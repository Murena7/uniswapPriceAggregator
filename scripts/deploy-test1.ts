...
async function main() {
    ...
    // const result1 = await webContract.methods.getCurrentPrice('0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', '0xdac17f958d2ee523a2206206994597c13d831ec7').call();
    ...
    for (let i = 0; i < pairAddressesArr.length; i++ ) {
        console.log('Result', i, buildBalanceTransformer(new BigNumber(pairAddressesArr[i].getPrice.toString()), pairAddressesArr[i].getDecimal).toString(), pairAddressesArr[i].getSymbol, pairAddressesArr[i].getDecimal);
    }
